  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md py-5 px-5 md:px-10 ">
        ...
        <div className=" flex items-center md:border-2 rounded-full py-2 md:shadow-sm">
            ...
            <MagnifyingGlassIcon className=" hidden md:inline-flex h-8 bg-red-400 text-white rounded-full p-2 
        ...
        {searchInput && (
            <div className="flex flex-col col-span-3 mx-auto mt-1 ">
              ...
              <div className="flex">
                <button onClick={resetInput} className="flex-grow text-gray-400 border mx-1 rounded-1xl">Cancel</button>
                <button onClick={search} className="flex-grow text-red-400 border rounded-1xl">Search</button>
              </div>
            </div>
